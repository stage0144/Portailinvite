...
<html lang="fr">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="//10.44.55.167/Portailinvite/assets/css/app.css" />
        <link rel="stylesheet" type="text/css" href="//10.44.55.167/Portailinvite/assets/css/fonts.css" />
...
<div class="col-xs-12">
    ...
    <div class="formulaire"> 
        ...
        <div class="col-xs-12 col-sm-6 col-sm-offset-1">
            ...
            <h2>Ajout d'un nouveau type de compte</h2>
             <?php echo form_open(''); ?>
	    <div name="login" role="form" class="form-horizontal" method="post" accept-charset="utf-8">
                <div class="form-group">
                <div class="col-md-8"><input name="type" placeholder="Type de compte" class="form-control" type="text" id="nom"/></div>
             </div> 
